...
export function PeripheralGroupFormConnected(props: {ID:number, profile: Profile, setAlreadySaved:(v:boolean) => void, setHasChanges:(v:boolean) => void, setIsSaveLoading:(v:boolean) => void, saveNode: HTMLElement }) {
    const {ID, ...rest} = props;
